...
@RegisterPlugin
@Produces(HerbFacet.class)
@Requires(@Facet(SurfaceHeightFacet.class))
public class HerbProvider implements FacetProviderPlugin {
    private Noise noise;
    ...
    public void process(GeneratingRegion region) {
        Border3D border = region.getBorderForFacet(HerbFacet.class);
        HerbFacet facet = new HerbFacet(region.getRegion(), border);
        ...
        region.setRegionFacet(HerbFacet.class, facet);
    }
}
